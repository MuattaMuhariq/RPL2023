  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 ">
        ...
        <li>
            <a href="#" class="block py-2 pl-3 pr-4 text-black rounded hover:bg-black md:hover:bg-transparent md:border-0 md:hover:text-black md:p-0 dark:text-white md:dark:hover:text-black dark:hover:bg-black dark:hover:text-white md:dark:hover:bg-transparent">HISTROY</a>
        </li>
        <li>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <li>
          <a href="#" class="block py-2 pl-3 pr-4 text-black rounded hover:bg-blue-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-800 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">User</a>
        </li>
      </ul>
    </div>
  </div>
